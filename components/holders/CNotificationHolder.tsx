  ...
  useEffect(() => {
    if (notifications && notifications.length > 0) {
      ...
      if (newNotificationTimestamp > lastNotificationTimestamp) {
        ...
        const notificationAudio = new Audio("/audio.wav");
        notificationAudio.play(); // eslint-disable-line
            ...
            <div className="flex flex-col gap-2">
              {notifications.length === 0 ? (
                ...
                notifications.map((notification) => {
                  ...
                  if (
                    notification.notification_type_name === "no information"
                  ) {
                    return (
                      <div
                  ...
                  } else if (notification.notification_type_name === "error") {
                    return (
                      <div
                        key={notification._id}
