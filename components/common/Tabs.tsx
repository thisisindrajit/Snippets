...
const Tabs: FC<{ active: number }> = ({ active }) => {
  return (
    <div
      className="grid grid-cols-3 xl:hidden gap-1 rounded-lg border border-primary/50 text-sm p-1 w-full md:w-3/5 m-auto sticky top-[4.5rem] bg-background shadow-lg z-30"
    >
      <Link
        href="/user/dashboard"
