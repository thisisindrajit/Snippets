  ...
  return (
    <div className="border border-primary shadow-lg rounded-lg flex flex-col justify-between p-3 sm:p-4 gap-4 sm:gap-6">
      ...
      <Link
        ...
        className="bg-secondary/5 flex items-center justify-center gap-1.5 text-sm w-full lg:w-fit mx-auto mr-0 text-secondary p-2 sm:px-3 sm:py-2 rounded-md border border-secondary"
        target="_blank"
      >
        View Snippet
